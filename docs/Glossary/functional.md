...
{
    data[i] = true_dist(seed_generator);
}
...
std::vector<double> fill_vec(int index, int max_index, 
    std::vector<double> vec, std::normal_distribution distrib, std::mt19937_64& seed)
{
    if (index < max_index)
    {
